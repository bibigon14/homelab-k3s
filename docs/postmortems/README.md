...
| Date | Title | Severity |
|---|---|---|
| 2026-07-29 | [Thanos Compact corruption recurs: four new R2 blocks fail checksum validation, one crash loop exhausts restart limit](./2026-07-29-thanos-compact-r2-block-corruption.md) | SEV-2 |
